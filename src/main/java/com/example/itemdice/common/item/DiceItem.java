...
public class DiceItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> lines, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            if ("d4".equals(net.minecraftforge.registries.ForgeRegistries.ITEMS.getKey(this).getPath())) lines.add(Component.translatable("tooltip.itemdice.d4.snapshot").withStyle(ChatFormatting.GOLD));
